...
const Home = () => {
  ...
  const gestoriasFiltradas = gestorias
    ...
    .sort((a, b) => {
      ...
      if (orden === "ratingUp")
        return (
          (a.ratings?.["Valoración Global"] || 0) -
          (b.ratings?.["Valoración Global"] || 0)
        );
      if (orden === "ratingDown")
        return (
          (b.ratings?.["Valoración Global"] || 0) -
  ...
  return (
    <div className="p-6">
      ...
      <div className="text-center my-6">
        <h1 className="text-4xl font-bold mb-2">TaxRating</h1>
        <p className="text-gray-600 text-lg">
          Valoraciones objetivas de gestorías y asesorías fiscales
        </p>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-6">
        ...
        >
          ...
          {[...new Set(gestorias.map((g) => g.province))]
            .sort()
            .map((p) => (
          ...
          >
            ...
            {g.website && (
              <a
                ...
                rel="noreferrer"
              >
                <FaGlobe className="inline" /> <span className="underline">Web</span>
              </a>
            )}
            {g.location && (
              <a
                ...
                rel="noreferrer"
              >
                <FaMapMarkerAlt className="inline" /> <span className="underline">Ubicación</span>
              </a>
            )}
          </div>
        ))}
